...
const LESSONS := [
	...
	{"title": "Green", "body": "Green can claim a matching Set. Its Corral stores a tile safely while you draw a replacement, then returns it on a later draw.", "actions": [&"green"]},
	{"title": "Pink", "body": "Pink can establish your Pair from a public discard. Its neutral exchange offers a tile and draws a replacement.", "actions": [&"pink"]},
	{"title": "Dark", "body": "Dark denies the latest opposing discard before it can be claimed. The denial is logged and remains visible.", "actions": [&"dark"]},
	{"title": "Purple", "body": "Purple visibly reveals and reorders the next wall tiles. It never lets an NPC read the wall without this announced effect.", "actions": [&"purple"]},
	{"title": "Frontier Rules", "body": "Frontier Rules uses 136 tiles, fourteen-tile hands, and legal quads. Four groups and a pair still make a hand.", "actions": []},
