...
const SUITES := [
	...
	"res://tests/unit/test_quest_event.gd",
	"res://tests/unit/test_quest_definition_validator.gd",
	"res://tests/unit/test_quest_objective_evaluator.gd",
	"res://tests/unit/test_quest_event_adapter.gd",
	"res://tests/unit/test_quest_ui.gd",
	"res://tests/unit/test_dialogue_sequence_validator.gd",
	"res://tests/unit/test_dialogue_sequence_runner.gd",
	"res://tests/integration/test_mayor_bell_dialogue_pilot.gd",
	"res://tests/unit/test_content_validation_report.gd",
	"res://tests/integration/test_vertical_slice_progression.gd",
	"res://tests/integration/test_first_lantern_objectives.gd",
	...
	"res://tests/unit/test_phase_nine_ten.gd",
